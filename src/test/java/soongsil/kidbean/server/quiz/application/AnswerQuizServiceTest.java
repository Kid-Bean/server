...
class AnswerQuizServiceTest {
    ...
    void getAnswerQuizById() {
        // given
        given(answerQuizRepository.findByQuizIdAndMember_MemberId(anyLong(), anyLong())).willReturn(Optional.of(ANSWER_QUIZ));

        // when
        AnswerQuizMemberDetailResponse response = answerQuizService.getAnswerQuizById(MEMBER1.getMemberId(), ANSWER_QUIZ.getQuizId());
    ...
    void uploadAnswerQuiz() {
        // given
        AnswerQuizUploadRequest request = new AnswerQuizUploadRequest(ANSWER_QUIZ.getTitle(), ANSWER_QUIZ.getQuestion());
    ...
    void updateAnswerQuiz() {
        // given
        AnswerQuizUpdateRequest request = new AnswerQuizUpdateRequest(ANSWER_QUIZ.getTitle(), ANSWER_QUIZ.getQuestion());
