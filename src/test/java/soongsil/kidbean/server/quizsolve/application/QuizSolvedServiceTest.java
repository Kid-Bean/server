...
import soongsil.kidbean.server.quizsolve.application.quizscorer.ImageQuizScorer;
import soongsil.kidbean.server.quizsolve.application.quizscorer.QuizScorerFactory;
import soongsil.kidbean.server.quizsolve.application.quizscorer.WordQuizScorer;
import soongsil.kidbean.server.quizsolve.application.quizsolver.ImageQuizSolver;
import soongsil.kidbean.server.quizsolve.application.quizsolver.QuizSolverFactory;
import soongsil.kidbean.server.quizsolve.application.quizsolver.WordQuizSolver;
