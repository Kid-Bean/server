...
public class ProgramInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        if (programRepository.count() > 0) {
            ...
            Program PROGRAM7 = Program.builder()
                    .programInfo(ProgramInfo.builder()
            ...
            Program PROGRAM8 = Program.builder()
                    .programInfo(ProgramInfo.builder()
            ...
            Program PROGRAM9 = Program.builder()
                    .programInfo(ProgramInfo.builder()
            ...
            Program PROGRAM10 = Program.builder()
                    .programInfo(ProgramInfo.builder()
            ...
            Program PROGRAM11 = Program.builder()
                    .programInfo(ProgramInfo.builder()
            ...
            Program PROGRAM12 = Program.builder()
                    .programInfo(ProgramInfo.builder()
