    ...
    public static final Program PROGRAM6 = Program.builder()
            .programInfo(ProgramInfo.builder()
                    ...
                    .programS3Info(S3Info.builder()
                            .folderName("program/ACADEMY")
                            .fileName("third.jpg")
                            .s3Url("https://kidbean.s3.ap-northeast-2.amazonaws.comprogram/program/ACADEMY/third.jpg")
                            .build()
                    )
                    .build())
            .departmentInfo(DepartmentInfo.builder()
    ...
    public static final Program PROGRAM7 = Program.builder()
            .programInfo(ProgramInfo.builder()
                    ...
                    .programS3Info(S3Info.builder()
                            .folderName("program/ACADEMY")
                            .fileName("fourth.jpg")
                            .s3Url("https://kidbean.s3.ap-northeast-2.amazonaws.comprogram/program/ACADEMY/fourth.jpg")
                            .build()
                    )
                    .build())
            .departmentInfo(DepartmentInfo.builder()
    ...
    public static final Program PROGRAM8 = Program.builder()
            .programInfo(ProgramInfo.builder()
                    ...
                    .programS3Info(S3Info.builder()
                            .folderName("program/ACADEMY")
                            .fileName("fifth.jpg")
                            .s3Url("https://kidbean.s3.ap-northeast-2.amazonaws.comprogram/program/ACADEMY/fifth.jpg")
                            .build()
                    )
                    .build())
            .departmentInfo(DepartmentInfo.builder()
    ...
    public static final Program PROGRAM9 = Program.builder()
            .programInfo(ProgramInfo.builder()
                    ...
                    .programS3Info(S3Info.builder()
                            .folderName("program/ACADEMY")
                            .fileName("sixth.jpg")
                            .s3Url("https://kidbean.s3.ap-northeast-2.amazonaws.comprogram/program/ACADEMY/sixth.jpg")
                            .build()
                    )
                    .build())
            .departmentInfo(DepartmentInfo.builder()
