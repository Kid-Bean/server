...
public class ImageQuizInitializer implements ApplicationRunner {
    ...
    private static final ImageQuiz IMAGE_QUIZ_ANIMAL2 = ImageQuiz.builder()
            .quizCategory(ANIMAL)
            .level(SILVER)
            .title("bee")
            .answer("꿀벌")
    ...
    public static final ImageQuiz IMAGE_QUIZ_ANIMAL3 = ImageQuiz.builder()
            .quizCategory(ANIMAL)
            .level(GOLD)
            .title("fish")
            .answer("물고기")
    ...
    private static final ImageQuiz IMAGE_QUIZ_ANIMAL4 = ImageQuiz.builder()
            .quizCategory(ANIMAL)
            .level(PLATINUM)
            .title("giraffe")
            .answer("기린")
    ...
    private static final ImageQuiz IMAGE_QUIZ_ANIMAL5 = ImageQuiz.builder()
            .quizCategory(ANIMAL)
            .level(DIAMOND)
            .title("lion")
            .answer("사자")
    ...
    private static final ImageQuiz IMAGE_QUIZ_ANIMAL6 = ImageQuiz.builder()
            .quizCategory(ANIMAL)
            .level(DIAMOND)
            .title("pig")
            .answer("돼지")
    ...
    private static final ImageQuiz IMAGE_QUIZ_ANIMAL7 = ImageQuiz.builder()
            .quizCategory(ANIMAL)
            .level(DIAMOND)
            .title("rhino")
            .answer("코뿔소")
    ...
    public static final ImageQuiz IMAGE_QUIZ_FOOD1 = ImageQuiz.builder()
            .quizCategory(FOOD)
            .level(BRONZE)
            .title("hamburger")
            .answer("햄버거")
    ...
    private static final ImageQuiz IMAGE_QUIZ_FOOD2 = ImageQuiz.builder()
            .quizCategory(FOOD)
            .level(SILVER)
            .title("pancake")
            .answer("팬케이크")
    ...
    private static final ImageQuiz IMAGE_QUIZ_FOOD3 = ImageQuiz.builder()
            .quizCategory(FOOD)
            .level(GOLD)
            .title("pizza")
            .answer("피자")
    ...
    private static final ImageQuiz IMAGE_QUIZ_FOOD4 = ImageQuiz.builder()
            .quizCategory(FOOD)
            .level(BRONZE)
            .title("sushi")
            .answer("초밥")
    ...
    private static final ImageQuiz IMAGE_QUIZ_FOOD5 = ImageQuiz.builder()
            .quizCategory(FOOD)
            .level(BRONZE)
            .title("dumpling")
            .answer("만두")
            ...
            .member(DUMMY_MEMBER)
            .build();
    private static final ImageQuiz IMAGE_QUIZ_NONE1 = ImageQuiz.builder()
            .quizCategory(NONE)
            .level(BRONZE)
            .title("tissue")
            .answer("화장지")
    ...
    private static final ImageQuiz IMAGE_QUIZ_NONE2 = ImageQuiz.builder()
            .quizCategory(NONE)
            .level(SILVER)
            .title("hand")
            .answer("손")
    ...
    private static final ImageQuiz IMAGE_QUIZ_NONE3 = ImageQuiz.builder()
            .quizCategory(NONE)
            .level(GOLD)
            .title("chair")
            .answer("의자")
    ...
    private static final ImageQuiz IMAGE_QUIZ_NONE4 = ImageQuiz.builder()
            .quizCategory(NONE)
            .level(PLATINUM)
            .title("doctor")
            .answer("의사")
    ...
    private static final ImageQuiz IMAGE_QUIZ_NONE5 = ImageQuiz.builder()
            .quizCategory(NONE)
            .level(DIAMOND)
            .title("foot")
            .answer("발")
    ...
    private static final ImageQuiz IMAGE_QUIZ_NONE6 = ImageQuiz.builder()
            .quizCategory(NONE)
            .level(PLATINUM)
            .title("car")
            .answer("자동차")
    ...
    private static final ImageQuiz IMAGE_QUIZ_OBJECT1 = ImageQuiz.builder()
            .quizCategory(OBJECT)
            .level(BRONZE)
            .title("cap")
            .answer("모자")
    ...
    private static final ImageQuiz IMAGE_QUIZ_OBJECT2 = ImageQuiz.builder()
            .quizCategory(OBJECT)
            .level(SILVER)
            .title("eraser")
            .answer("지우개")
    ...
    private static final ImageQuiz IMAGE_QUIZ_OBJECT3 = ImageQuiz.builder()
            .quizCategory(OBJECT)
            .level(GOLD)
            .title("bag")
            .answer("가방")
    ...
    private static final ImageQuiz IMAGE_QUIZ_OBJECT4 = ImageQuiz.builder()
            .quizCategory(OBJECT)
            .level(PLATINUM)
            .title("ball")
            .answer("공")
    ...
    private static final ImageQuiz IMAGE_QUIZ_OBJECT5 = ImageQuiz.builder()
            .quizCategory(OBJECT)
            .level(DIAMOND)
            .title("pencil")
            .answer("연필")
    ...
    private static final ImageQuiz IMAGE_QUIZ_OBJECT6 = ImageQuiz.builder()
            .quizCategory(OBJECT)
            .level(PLATINUM)
            .title("scissors")
            .answer("가위")
    ...
    private static final ImageQuiz IMAGE_QUIZ_PLANT1 = ImageQuiz.builder()
            .quizCategory(PLANT)
            .level(BRONZE)
            .title("cactus")
            .answer("선인장")
    ...
    private static final ImageQuiz IMAGE_QUIZ_PLANT2 = ImageQuiz.builder()
            .quizCategory(PLANT)
            .level(SILVER)
            .title("aloe")
            .answer("알로에")
    ...
    private static final ImageQuiz IMAGE_QUIZ_PLANT3 = ImageQuiz.builder()
            .quizCategory(PLANT)
            .level(GOLD)
            .title("potato")
            .answer("감자")
    ...
    private static final ImageQuiz IMAGE_QUIZ_PLANT4 = ImageQuiz.builder()
            .quizCategory(PLANT)
            .level(PLATINUM)
            .title("strawberry")
            .answer("딸기")
    ...
    private static final ImageQuiz IMAGE_QUIZ_PLANT5 = ImageQuiz.builder()
            .quizCategory(PLANT)
            .level(PLATINUM)
            .title("sunflower")
            .answer("해바라기")
    ...
    private static final ImageQuiz IMAGE_QUIZ_PLANT6 = ImageQuiz.builder()
            .quizCategory(PLANT)
            .level(PLATINUM)
    ...
    private static final ImageQuiz IMAGE_QUIZ_PLANT7 = ImageQuiz.builder()
            .quizCategory(PLANT)
            .level(PLATINUM)
            .title("tree")
            .answer("나무")
